...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICINES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MEDICINES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICINES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICINES actions', async () => {
      const arg = { id: 17276 };
    ...
    it('dispatches UPDATE_MEDICINES actions', async () => {
      const arg = { id: 17276 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICINES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICINES actions', async () => {
      const arg = 42666;
