...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASEITEMS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PURCHASEITEMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PURCHASEITEMS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PURCHASEITEMS actions', async () => {
      const arg = { id: 17780 };
    ...
    it('dispatches UPDATE_PURCHASEITEMS actions', async () => {
      const arg = { id: 17780 };
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASEITEMS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PURCHASEITEMS actions', async () => {
      const arg = 42666;
