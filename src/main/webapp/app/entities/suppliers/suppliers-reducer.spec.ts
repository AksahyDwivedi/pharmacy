...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLIERS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUPPLIERS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPLIERS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPLIERS actions', async () => {
      const arg = { id: 21311 };
    ...
    it('dispatches UPDATE_SUPPLIERS actions', async () => {
      const arg = { id: 21311 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLIERS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPLIERS actions', async () => {
      const arg = 42666;
