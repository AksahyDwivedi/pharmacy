...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PAYMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTS actions', async () => {
      const arg = { id: 26688 };
    ...
    it('dispatches UPDATE_PAYMENTS actions', async () => {
      const arg = { id: 26688 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTS actions', async () => {
      const arg = 42666;
