...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SALES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SALES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SALES actions', async () => {
      const arg = { id: 9973 };
    ...
    it('dispatches UPDATE_SALES actions', async () => {
      const arg = { id: 9973 };
    ...
    it('dispatches PARTIAL_UPDATE_SALES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SALES actions', async () => {
      const arg = 42666;
