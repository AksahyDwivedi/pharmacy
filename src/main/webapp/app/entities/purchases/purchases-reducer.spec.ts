...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PURCHASES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PURCHASES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PURCHASES actions', async () => {
      const arg = { id: 4022 };
    ...
    it('dispatches UPDATE_PURCHASES actions', async () => {
      const arg = { id: 4022 };
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PURCHASES actions', async () => {
      const arg = 42666;
