...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICINEBATCHES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_MEDICINEBATCHES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICINEBATCHES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICINEBATCHES actions', async () => {
      const arg = { id: 30100 };
    ...
    it('dispatches UPDATE_MEDICINEBATCHES actions', async () => {
      const arg = { id: 30100 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICINEBATCHES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICINEBATCHES actions', async () => {
      const arg = 42666;
