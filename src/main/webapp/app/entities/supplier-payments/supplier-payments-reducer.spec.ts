...
import { ISupplierPayments, defaultValue } from 'app/shared/model/supplier-payments.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  searchEntities,
  updateEntity,
} from './supplier-payments.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLIERPAYMENTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUPPLIERPAYMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPLIERPAYMENTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPLIERPAYMENTS actions', async () => {
      const arg = { id: 18399 };
    ...
    it('dispatches UPDATE_SUPPLIERPAYMENTS actions', async () => {
      const arg = { id: 18399 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLIERPAYMENTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPLIERPAYMENTS actions', async () => {
      const arg = 42666;
