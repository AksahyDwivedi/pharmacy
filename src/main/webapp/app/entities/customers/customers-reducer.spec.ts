...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CUSTOMERS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMERS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMERS actions', async () => {
      const arg = { id: 20569 };
    ...
    it('dispatches UPDATE_CUSTOMERS actions', async () => {
      const arg = { id: 20569 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMERS actions', async () => {
      const arg = 42666;
