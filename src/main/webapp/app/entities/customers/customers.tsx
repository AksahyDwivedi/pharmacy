...
import { getEntities, searchEntities } from './customers.reducer';
  ...
  return (
    <div>
      <h2 id="customers-heading" data-cy="CustomersHeading">
        <Translate contentKey="hmPharmacyApp.customers.home.title">Customers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hmPharmacyApp.customers.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/customers/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hmPharmacyApp.customers.home.createLabel">Create new Customers</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('hmPharmacyApp.customers.home.search')}
                />
        ...
        {customersList && customersList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hmPharmacyApp.customers.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hmPharmacyApp.customers.home.notFound">No Customers found</Translate>
            </div>
          )
        )}
      </div>
