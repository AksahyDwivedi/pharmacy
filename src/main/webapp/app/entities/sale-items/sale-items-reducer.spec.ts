...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALEITEMS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SALEITEMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SALEITEMS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SALEITEMS actions', async () => {
      const arg = { id: 3359 };
    ...
    it('dispatches UPDATE_SALEITEMS actions', async () => {
      const arg = { id: 3359 };
    ...
    it('dispatches PARTIAL_UPDATE_SALEITEMS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SALEITEMS actions', async () => {
      const arg = 42666;
