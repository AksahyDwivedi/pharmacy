...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESCRIPTIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PRESCRIPTIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRESCRIPTIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRESCRIPTIONS actions', async () => {
      const arg = { id: 7159 };
    ...
    it('dispatches UPDATE_PRESCRIPTIONS actions', async () => {
      const arg = { id: 7159 };
    ...
    it('dispatches PARTIAL_UPDATE_PRESCRIPTIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRESCRIPTIONS actions', async () => {
      const arg = 42666;
